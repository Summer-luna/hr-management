  ...
  return (
    <>
      <Typography variant="h5">
        {targetEmployee ? "Edit" : "Create a new employee"}
      </Typography>
      <Formik
        ...
        onSubmit={async (values) => {
          ...
          if (!targetEmployee) {
            ...
            res.data?.addEmployee &&
              toggleSnackBar("Successfully created a new employee!", {
                variant: "success",
              });
          } else {
            ...
            res.data?.updateEmployee &&
              toggleSnackBar("Successfully update the employee!", {
                variant: "success",
              });
          }
          return handleClose();
      ...
      {error &&
        toggleSnackBar("There are something wrong!", { variant: "error" })}
    </>
  );
};
